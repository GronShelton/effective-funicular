...
nohup /usr/lib/jvm/java-1.11.0-openjdk-amd64/bin/java -classpath ".:./lib/js.jar:./lib/jzlib.jar:./lib/mysql-connector-java-8.0.21.jar" -Xms129m -Xmx256m com.planet_ink.coffee_mud.application.MUD "GronMUD" &
